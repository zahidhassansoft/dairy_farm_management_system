    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-success">
                {!! Form::open(['url' => ['cowsale',$data->id], 'method' =>'PATCH', 'id'=>'validate','class'=>'formsave','enctype'=>"multipart/form-data"]) !!}
                @csrf
                <div class="box-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="date" id="date" class="form-control wsit_datepicker" value="{{ date('Y-m-d',strtotime($data->date)) }}" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Customer Name <span class="validate">*</span> : </label>
                                                <input type="text" name="customer_name" id="customer_name" class="form-control" value="{{$data->customer_name}}" required>
                                                <input type="hidden" name="invoice_no" id="invoice_no" class="form-control" value="{{$data->invoice_no}}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Phone Number <span class="validate">*</span> : </label>
                                                <input type="text" name="customer_phone" id="customer_phone" class="form-control" value="{{$data->customer_phone}}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Customer Email : </label>
                                                <input type="text" name="customer_email" id="customer_email" class="form-control" value="{{$data->customer_email}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <table class="table grid-table">
                                            <thead id="table" name="table">
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{ URL::asset($data->image) }}" id="image" name="image" class="img-thumbnail img-width-150">
                                                    </td>
                                                    <td class="verticalAlign">
                                                        <select class="form-control" id="cowtype" name="cowtype">
                                                            <option value="">-- Select --</option>
                                                            <option value="1" {{$data->animal_type == '1' ? 'selected' : '' }}>Cow</option>
                                                            <option value="2" {{$data->animal_type == '2' ? 'selected' : '' }}>Calf</option>
                                                        </select>
                                                    </td>
                                                    <td class="verticalAlign">
                                                    ...
                                                    <td class="verticalAlign">
                                                        <input type="text" id="stall_no" name="stall_no" class="form-control" value="{{$data->stall_no}}" readonly>
                                                    </td>
                                                </tr>
                                                </tr>
                                            </thead>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="total_price" class="form-control isnumber" id="total_price" value="{{$data->sale_price}}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="total_paid">Paid <span class="validate">*</span> : </label>
                                                <input type="text" name="total_paid" class="form-control isnumber" id="total_paid" value="{{$data->paid_amount}}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="due">Due Amount : </label>
                                                <input type="text" name="due_amount" class="form-control" id="due_amount" value="{{$data->due_amount}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready(function() {
        $('#cowtype').change(function() {
            ...
            if (id == 1) {
                $.ajax({
                    url: "http://127.0.0.1:8000/cowsale/getanimalidforcow/" + id,
                    type: "GET",
                    dataType: "JSON",
                ...
                $.ajax({
                    url: "http://127.0.0.1:8000/cowsale/getanimalidforcalf/" + id,
                    type: "GET",
                    dataType: "JSON",
                    success: function(data) {
                        // console.log(data);
        ...
        $('#animal_id').change(function() {
            ...
            $.ajax({
                url: "http://127.0.0.1:8000/cowsale/getstallimage/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
                    var obj = JSON.parse(JSON.stringify(data));
