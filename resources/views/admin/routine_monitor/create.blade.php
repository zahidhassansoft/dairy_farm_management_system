                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="date" type="text" name="date" class="form-control datepicker" autocomplete="off" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                    ...
                                    <div class="col-md-3 animal-box-height" id="div_0">
                                        <div class="panel-body" id="imageBlock">
                                            <div class="upload-builder-2">
                                                ...
                                                <img src="{{url('frontend/images/cow.jpg')}}" style="height:185px" class="manage-animal-upload" id="previewImage_0">
                                        ...
                                        <table class="table grid-table">
                                            <thead id="table" name="table">
                                                <tr style="margin-bottom: -10px;">
                                                    <th class="col-sm-4">Service Name</td>
                                                    <th class="col-sm-4">Result</th>
                                                    <th class="col-sm-4">Monitoring Time</th>
                                                </tr>
                                                <tr>
                                                    <td>
