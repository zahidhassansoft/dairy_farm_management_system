...
<div class="wrapper">
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1><i class="fa fa-tint" aria-hidden="true" ></i> Color</h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            <div class="box box-success">
                {!! Form::open(['url' => '/colorstore', 'method' =>'post', 'id'=>'validate','class'=>'formsave']) !!}
                @csrf
                <div class="box-body">
                    <div class="col-sm-4 col-md-offset-4">
                        <div class="panel panel-default">
                            <div class="panel-heading"><i class="fa fa-plus-square" style="color: green"></i> Add new color</div>
