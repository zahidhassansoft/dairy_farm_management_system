...
<div class="wrapper">
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1><i class="fa fa-university" aria-hidden="true"></i> Color Udpate</h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            <div class="box box-success">
                {!! Form::open(['url' => ['/color/update',$data->id], 'method' =>'post', 'id'=>'validate','class'=>'formsave']) !!}
                @csrf
                <div class="box-body">
                    <div class="col-sm-4 col-md-offset-4">
                        <div class="panel panel-default">
                            <div class="panel-heading"><i class="fa fa-plus-square" style="color: green"></i> Update color</div>
                        ...
                        <div class="text-right">
                            ...
                            <!-- &nbsp; -->
                            <a href="{{url('colors')}}" class="btn btn-warning "><i class="fa fa-list"></i> <b> List</b></a>
                        </div>
                    </div>
                </div>
                {{ csrf_field() }}
