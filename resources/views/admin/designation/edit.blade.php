...
<div class="wrapper">
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1><i class="fa fa-cutlery" aria-hidden="true"></i> Upadate Designation</h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            <div class="box box-success">
                {!! Form::open(['url' => ['designation',$data->id], 'method' =>'PATCH', 'id'=>'validate','class'=>'formsave']) !!}
                @csrf
                <div class="box-body">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="details" id="details" class="form-control" value="{{$data->details}}">
                                    </div>
                                </div>
                            </div>
                        </div>
