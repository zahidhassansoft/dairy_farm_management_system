...
<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-list" aria-hidden="true"></i> Expense Purpose List</h1>
        <ol class="breadcrumb">
                        ...
                        <table class="table table-bordered table-striped table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$rows->name}}</td>
                                    <td>
                                        <a href="{{url('expensepurpose/'.$rows->id.'/edit')}}" class="btn btn-default btn-sm"><i class="fa fa-edit"></i></a>
                                        {!! Form::open(['method' => 'DELETE','url' => ['expensepurpose', $rows->id],'style'=>'display:inline']) !!}
