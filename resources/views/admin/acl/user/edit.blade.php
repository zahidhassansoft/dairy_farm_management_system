            ...
            <div class="col-sm-8 col-sm-offset-2">
                <div class="box box-info">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('username', $user->username, array('placeholder' => 'User Name','class' => 'form-control', 'id'=>'txtUserName')) !!}
                                </div>
                                <div class="form-group">
                                    <strong>Name:</strong>
                                    {!! Form::text('name', $user->name, array('placeholder' => 'Name','class' => 'form-control', 'id'=>'txtName')) !!}
                                </div>
                                <div class="form-group">
                                    <strong>Email:</strong>
                                    {!! Form::text('email', $user->email, array('placeholder' => 'Email','class' => 'form-control', 'id'=>'txtEmail')) !!}
                                </div>
                                <div class="form-group">
                                    <strong>Designation:</strong>
                                    {!! Form::text('designation', $user->designation, array('placeholder' => 'Designation','class' => 'form-control', 'id'=>'txtDesignation')) !!}
                                </div>
                                <div class="form-group">
                    ...
                    <ul class="trees">
                        ...
                        <li id="parent">
                            <input type="checkbox" class="menus" value="{{$menu->id}}" {{ in_array($menu->id, $userRole) ? 'checked' : null}}> {{$menu->name}}
    ...
    function update() {
        ...
        if (res == true) {
            ...
            $.ajax({
                type: "POST",
                url: '/users/{{$user->id}}',
                data: {data:vouchers,_token: "{{ csrf_token() }}",_method:"PUT"},
