...
<div class="wrapper">
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1><i class="fa fa-cutlery" aria-hidden="true"></i> Upadate Food Item</h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            <div class="box box-success">
                {!! Form::open(['url' => ['fooditem',$data->id], 'method' =>'PATCH', 'id'=>'validate','class'=>'formsave']) !!}
                @csrf
                <div class="box-body">
                    <div class="col-sm-4 col-md-offset-4">
                        ...
                        <div class="text-right">
                            ...
                            <!-- &nbsp; -->
                             <a href="{{url('fooditem')}}" class="btn btn-warning "><i class="fa fa-list"></i> <b> List</b></a>                        </div>
                         </div>
                </div>
                {{ csrf_field() }}
                {!! Form::close() !!}
